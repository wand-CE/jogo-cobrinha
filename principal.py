...
def reiniciar_jogo():
    global pontos, comprimento_inicial, x_cobra, y_cobra, lista_cobra
    global lista_cabeca, x_maca, y_maca, morreu
...
#                                  texto, serrilhado, cor texto
    ...
    if lista_cobra.count(lista_cabeca) > 1:
        ...
        mensagem2 = 'GAME OVER! Pressione a tecla R para reiniciar o jogo!!!'
